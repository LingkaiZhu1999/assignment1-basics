...
if __name__ == "__main__":
    ...
    parser.add_argument("--d_model", default=784, help="dimension of model")
    parser.add_argument("--d_ff", default=3,)
    parser.add_argument("--vocab_size",default=30000, help="10000 for tinystories, 30000 for owt")
    parser.add_argument("--num_layers", default=3)
    parser.add_argument("--num_heads", default=100)
